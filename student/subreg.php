        ...
        <main>
            ...
            <section class="profile_section">
                <div class="joinMain" id="main" style="height:250px">
                    ...
                    <?php 
                            // check database if the transaction has been updated
                            $payments->checkPayment($_GET['tx'],$_SESSION['student_subject_ID'],$_SESSION["account"]);
                            
                            echo $_GET['tx'].' '.$_SESSION['student_subject_ID'];
