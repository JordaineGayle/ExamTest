...
<div>Please Input Your Exam ID: <input name="id" type="number" id="examID" onkeypress="return isNumberKey(event)" placeholder="ExamID..." required/>&nbsp;<span id="feedback"></span></div><br/>
          <div>Please Input Your Your ID: <input name="sid" type="number" id="student" onkeypress="return isNumberKey(event)" placeholder="SutdentID..." required/>&nbsp;<span id="feedbacks"></span></div><br/>
          Unique Exam Key: <?php require("random.php"); ?><br/>
  ...
  <p id="res"></p>
    <script>
        ...
        $('#examID').keyup(function(){
           ...
           $('#feedback').html('<img src="ajax-loader.gif"/>');
            setTimeout(function(){
        ...
        $('#student').keyup(function(){
           ...
           $('#feedbacks').html('<img src="ajax-loader.gif"/>');
            setTimeout(function(){
